...
export default function FaleComigo({props}:IFaleComigoProps) {
    return (
        <section className="py-5" id="falecomigo">
            <div className="container flex max-w-5xl mx-auto px-4">
                <div className="flex flex-col text-center w-full space-y-10">
                    <h1 className="text-2xl md:text-3xl mb-1 md:mb-7">{props.nome}</h1>
                    <form className="w-full md:w-2/3 border shadow-xl p-5 rounded-lg md:mx-auto space-y-2 text-gray-600"
                        ...
                        <input id="name" className="w-full p-1 rounded-lg " required type="text" name="name" placeholder={props.formNome}
                            data-aos="fade-right" data-aos-delay="100" />
                        <input id="email" className="w-full p-1 rounded-lg" type="text" required name="email" placeholder={props.formEmail}
                            data-aos="fade-right" data-aos-delay="200" />
                        <textarea id="assunto" className="w-full p-1 rounded-lg" placeholder={props.formAssunto} required name="message" data-aos="fade-right"
                        ...
                        <input type="submit" className="w-full text-lg md:text-xl text-gray-100 rounded-xl bg-sky-600 p-2"
                            value={props.formBotao} data-aos="fade-right" data-aos-delay="400" />
                    </form>
